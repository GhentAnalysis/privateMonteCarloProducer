...
if [[ $spec == *"tauLeptonic"* ]]; then
  fragment='pythiaFragmentCP5_LO_tauLeptonic.py'
else
  fragment='pythiaFragmentCP5_LO.py'
fi
...
cp /user/tomc/public/production/$fragment Configuration/GenProduction/python/EXO-RunIIAutumn18wmLHEGS-heavyNeutrino-fragment.py 
