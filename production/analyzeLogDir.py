    ...
    if os.path.getsize(file) > 100000000: 
      ...
      with open(file) as f:
        ...
        for line in f:
          ...
          elif "with open(src, 'rb') as fsrc:"                                          in line: state    = 'Corrupt gridpack'
          elif 'No handlers could be found for logger "madevent.stdout"'                in line: state    = 'Corrupt gridpack'
          elif "can't read cmsgrid_final.lhert"                                         in line: state    = 'Corrupt gridpack'
          elif 'ImportError: No module named models.check_param_card'                   in line: state    = 'Corrupt gridpack'
          elif 'Unable to open script output file cmsgrid_final.lhe'                    in line: state    = 'Corrupt gridpack'
